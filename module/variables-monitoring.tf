...
variable "diag_log_categories" {
  ...
  type        = list(string)
  default = [
    # TODO: Add list of logging categories required for the resource type.
    # See: https://learn.microsoft.com/en-us/azure/azure-monitor/essentials/resource-logs-categories
    "",
    ""
  ]
}
